...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        panelDetails.Controls.Add(buttonKill);
        ...
        // buttonKill
        buttonKill.Location = new Point(10, y);
        buttonKill.Size = new Size(195, 35);
        buttonKill.Text = "Завершить процесс";
        buttonKill.BackColor = Color.FromArgb(220, 53, 69);
        buttonKill.ForeColor = Color.White;
        ...
        Text = "Модуль 2 Задание 3 — Завершение процесса";
